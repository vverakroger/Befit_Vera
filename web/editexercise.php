...
<html>
	...
	<body>
		<div class="container">
			<br>
			<h3 style="text-align:left">Edit exercise</h3>
			<form class="form-horizontal" method="POST" action="editexercise2.php" autocomplete="off">
						...
						<input type="number" class="form-control" id="minutes" value="<?php echo $row['mins']; ?>" name="minutes" placeholder="Mins" required>
						<br>
